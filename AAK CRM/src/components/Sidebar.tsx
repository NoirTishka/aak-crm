...
interface SideBarProps {
  kursants: Kursant[];
  setKursants: (list: Kursant[]) => void;
  selected: Kursant | null;
  setSelected: (k: Kursant | null) => void;
  showModal: boolean;
...
export function SideBar() {
    ...
    return (
        <div className="basis-1/3 flex flex-col border-r border-gray-200 bg-white h-screen">
        ...
        <div className="p-4 flex-shrink-0">
            ...
            className="bg-blue-600 hover:bg-blue-700 text-black py-2 rounded mb-4 text-sm w-full"
            >
            + Добавить курсанта
            </button>
        </div>
